...
pub async fn disclose_multiple_transactions(configuration: &configuration::Configuration, disclosure_request_multiple: models::DisclosureRequestMultiple) -> Result<Vec<models::DisclosedTransactionResult>, Error<DiscloseMultipleTransactionsError>> {
...
pub async fn disclose_single_transaction(configuration: &configuration::Configuration, disclosure_request_single: models::DisclosureRequestSingle) -> Result<models::Transaction, Error<DiscloseSingleTransactionError>> {
    // add a prefix to parameters to efficiently prevent name collisions
